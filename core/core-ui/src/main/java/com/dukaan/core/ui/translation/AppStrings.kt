...
class AppStrings {
    ...
    var finalDeleteConfirmTitle: String = "Are you sure?"
    var finalDeleteConfirmMessage: String = "This action is permanent. All transactions and data for this customer will be lost forever."
    var deletePermanently: String = "Delete Permanently"
    ...
    var scanList: String = "Scan List"
    var scanCustomerList: String = "Scan Customer's List"
    var scanListSubtitle: String = "Scan handwritten list"
    var scanningList: String = "Reading list..."
    var addToBill: String = "Add to Bill"
    var priceHint: String = "Price (₹)"
    var noItemsInList: String = "No items found in the list"
    var scanListError: String = "Could not read the list. Please try again."
    var chooseSource: String = "Choose Source"
    var camera: String = "Camera"
    var gallery: String = "Gallery"
    var itemsAddedToBill: String = "items added to bill!"
    var setPrice: String = "Set Price"
